...
public class ExampleUnitTest {
    ...
    public void cantidad_mujeres(){
        Persona p1 = new Persona("1456789","Jesus","sanjuan",0);
        Persona p2 = new Persona("1456788","carlos","Mejía",0);
        Persona p3 = new Persona("1456787","juan","Ramos",0);
        Persona p4 = new Persona("1454789","daniel","Peña",1);
